...
plt.plot(range(0,maxq),RRandom[IndexZero:-1],'r-' , label = u'R ataque aleatorio')
plt.plot(range(0,maxq),RDegree[IndexZero:-1],'g-' , label = u'R ataque por grado')
plt.plot(range(0,maxq),RCentrality[IndexZero:-1],'b-' , label = u'R ataque centralidad')
fontP = FontProperties()
fontP.set_size('small')
plt.xlabel('q', fontdict=font)
plt.ylabel(r'Indice R', fontdict=font)
plt.title(u'Indice R multifractalidad y robustez', fontdict=font)
