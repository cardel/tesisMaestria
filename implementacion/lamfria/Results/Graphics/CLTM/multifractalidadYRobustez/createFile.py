...
#fileOutput.write("plt.xlabel('Porcentaje de nodos eliminados (%)'))\n")
#fileOutput.write("plt.ylabel(u'Tamaño',fontdict=font)\n")	
#fileOutput.write("plt.title(u'Tamaño componente gigante'))\n")
...
#fileOutput.write("plt.title(u'Distancia promedio'))\n")
...
fileOutput.write("plt.xlabel('Escalado q')\n")
fileOutput.write("plt.ylabel(u'Dimensión fractal D(q)')\n")
fileOutput.write("plt.title(u'Multifractalidad ataque aleatorio')\n")
...
fileOutput.write("plt.xlabel('Escalado q')\n")
fileOutput.write("plt.ylabel(u'Dimensión fractal D(q)')\n")
fileOutput.write("plt.title(u'Multifractalidad ataque por grado')\n")
fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
fileOutput.write("plt.grid(True)\n")
...
fileOutput.write("plt.xlabel('Escalado (q)')\n")
fileOutput.write("plt.ylabel(u'Dimensión fractal D(q)')\n")
fileOutput.write("plt.title(u'Multifractalidad ataque por centralidad')\n")
fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
fileOutput.write("plt.grid(True)\n")
fileOutput.write("plt.savefig('DqCentrality'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')\n")
...
fileOutput.write("plt.xlabel('Escalado q')\n")
fileOutput.write("plt.ylabel(u'Dimensión fractal D(q)')\n")
fileOutput.write("plt.title(u'Dimensión fractal ataque Recocido simulado')\n")
fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
fileOutput.write("plt.grid(True)\n")
