...
#fileOutput.write("plt.title(u'Dimensión fractal ataque aleatorio Aleatorio')\n")
#fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
#fileOutput.write("plt.grid(True)\n")
...
#fileOutput.write("plt.xlabel('q')\n")
#fileOutput.write("plt.ylabel('D(q)')\n")
#fileOutput.write("plt.title(u'Dimensión fractal ataque aleatorio Grado')\n")
#fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
#fileOutput.write("plt.grid(True)\n")
...
#fileOutput.write("plt.xlabel('q')\n")
#fileOutput.write("plt.ylabel('D(q)')\n")
#fileOutput.write("plt.title(u'Dimensión fractal ataque aleatorio Centralidad')\n")
#fileOutput.write("lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))\n")
#fileOutput.write("plt.grid(True)\n")
