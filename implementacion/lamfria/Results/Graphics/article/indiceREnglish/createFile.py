...
fileOutput.write("numpy.set_printoptions(threshold=numpy.inf)\n")
...
fileOutput.write("plt.plot(range(0,maxq),RRandom[IndexZero:-1],'r-' , label = u'R random')\n")
fileOutput.write("plt.plot(range(0,maxq),RDegree[IndexZero:-1],'g-' , label = u'R degree')\n")
fileOutput.write("plt.plot(range(0,maxq),RCentrality[IndexZero:-1],'b-' , label = u'R centrality')\n")
...
fileOutput.write("plt.ylabel(r'R index', fontdict=font)\n")
...
fileOutput.write("plt.title(u'R index MFA', fontdict=font)\n")
