...
fileOutput.write("plt.xlabel('Lost nodes (%)', fontdict=font)\n")
fileOutput.write("plt.ylabel(r'Differential $\Delta D_q$', fontdict=font)\n")

fileOutput.write("plt.title(u'Multifractality and robustness', fontdict=font)\n")
