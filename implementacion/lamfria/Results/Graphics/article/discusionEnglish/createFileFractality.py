...
fileOutput.write("plt.plot(range(0,maxq), DqB[IndexZero:-1],'b<-' ,label='BCFS')\n")
...
fileOutput.write("plt.plot(range(0,maxq), DqH[IndexZero:-1],'r*-' ,label='Evolutivo BCFS')\n")
fileOutput.write("plt.plot(range(0,maxq), DqI[IndexZero:-1],'b*-' ,label='Recocido BCFS')\n")
