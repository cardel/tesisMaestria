...
timestr = 'grafica'
fig1 = plt.figure()
plt.xlabel('Porcentaje de nodos')
plt.ylabel(u'Tamaño')
plt.title(u'Medidas de robustez tamaño componente gigante')
plt.plot(percentNodes[0:GCRandom.shape[0]], GCRandom,'b<-' ,label='Aleatorio R='+str(numpy.sum(GCRandom)))
plt.plot(percentNodes[0:GCDegree.shape[0]], GCDegree,'g<-' ,label='Grado R='+str(numpy.sum(GCDegree)))
plt.plot(percentNodes[0:GCCentrality.shape[0]], GCCentrality,'r<-' ,label='Centralidad R='+str(numpy.sum(GCCentrality)))
plt.plot(percentNodes[0:GCGenetic.shape[0]], GCGenetic,'m<-' ,label='Genetico R='+str(numpy.sum(GCGenetic)))
plt.plot(percentNodes[0:GCSimulated.shape[0]], GCSimulated,'k<-' ,label='Recocido R='+str(numpy.sum(GCSimulated)))
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'GC'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
fig2 = plt.figure()
plt.xlabel('Porcentaje de nodos')
plt.ylabel(u'Diámetro camino')
plt.title(u'Medidas de robustez camino promedio en componente gigante')
plt.plot(percentNodes[0:APLRandom.shape[0]], APLRandom,'b<-' ,label='Aleatorio R='+str(numpy.sum(APLRandom)))
plt.plot(percentNodes[0:APLDegree.shape[0]], APLDegree,'g<-' ,label='Grado R='+str(numpy.sum(APLDegree)))
plt.plot(percentNodes[0:APLCentrality.shape[0]], APLCentrality,'r<-' ,label='Centralidad R='+str(numpy.sum(APLCentrality)))
plt.plot(percentNodes[0:APLGenetic.shape[0]], APLGenetic,'m<-' ,label='Genetico R='+str(numpy.sum(APLGenetic)))
plt.plot(percentNodes[0:APLSimulated.shape[0]], APLSimulated,'k<-' ,label='Recocido R='+str(numpy.sum(APLSimulated)))
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'APL'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
fig3 = plt.figure()
for i in range(0,9):
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque aleatorio Aleatorio')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque aleatorio Grado')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'DqDegree'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
fig5 = plt.figure()
for i in range(0,9):
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque aleatorio Centralidad')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'DqCentrality'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
fig6 = plt.figure()
for i in range(0,9):
	if i < DqGenetic.shape[0]:
		plt.plot(range(0,maxq),DqGenetic[i][IndexZero:-1],symbols[int(math.fmod(i,numpy.size(symbols)))], label='% nodes='+str(int(100*percentNodes[i]))+'%')
fontP = FontProperties()
fontP.set_size('small')
plt.legend(prop=fontP)
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque aleatorio Genetico')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'DqGenetic'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
fig6 = plt.figure()
for i in range(0,9):
	if i < DqSimulated.shape[0]:
		plt.plot(range(0,maxq),DqSimulated[i][IndexZero:-1],symbols[int(math.fmod(i,numpy.size(symbols)))], label='% nodes='+str(int(100*percentNodes[i]))+'%')
fontP = FontProperties()
fontP.set_size('small')
plt.legend(prop=fontP)
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque aleatorio Recocido')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
plt.savefig(timestr+'_'+'DqSimulated'+fileOutput+'.png', bbox_extra_artists=(lgd,),bbox_inches='tight')
