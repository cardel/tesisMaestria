...
plt.plot(percentNodes[0:GCGenetic.shape[0]], GCGenetic,'m<-' ,label='Genetico R='+"{0:.2f}".format(numpy.sum(GCGenetic)))
plt.plot(percentNodes[0:GCSimulated.shape[0]], GCSimulated,'k<-' ,label='Recocido R='+"{0:.2f}".format(numpy.sum(GCSimulated)))
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque Grado')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque Centralidad')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque Genetico')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
...
plt.xlabel('q')
plt.ylabel('D(q)')
plt.title(u'Dimensión fractal ataque Recocido')
lgd = plt.legend(loc='upper left', prop={'size':10}, bbox_to_anchor=(1,1))
plt.grid(True)
