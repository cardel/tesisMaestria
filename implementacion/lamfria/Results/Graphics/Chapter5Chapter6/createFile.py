...
fileOutput.write("plt.plot(percentNodes[0:GCGenetic.shape[0]], GCGenetic,'m<-' ,label='Genetico R='+\"{0:.2f}\".format(numpy.sum(GCGenetic)))\n")
fileOutput.write("plt.plot(percentNodes[0:GCSimulated.shape[0]], GCSimulated,'k<-' ,label='Recocido R='+\"{0:.2f}\".format(numpy.sum(GCSimulated)))\n")
