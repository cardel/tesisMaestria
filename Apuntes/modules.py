...
#
#The MEMB library you are using has not been updated since 2009 and 
#networkx has changed a lot since then, so some functions in the MEMB code
#no longer work. If you are having problems, try downloading an older 
#version of networkx, i.e., a version from 2008.
# 
